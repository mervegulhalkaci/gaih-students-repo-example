...
sorular = ['Hangisi kaymağı ile ünlü olan ilimizdir ?', 'Hangisi dondurması ile ünlü olan ilimizdir ?',
...
dogru_cevaplar = ['a', 'c', 'b', 'd', 'd', 'a', 'b', 'c', 'a', 'd']
